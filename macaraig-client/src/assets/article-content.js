const articles = [
  {
    ...
    content: [
      ...
      "Every piece we release is a product of months of design and testing to ensure premium comfort and bold aesthetics for the modern urban explorer.",
      "Join us as we continue to elevate the street culture, one drop at a time. This is more than fashion; it's a lifestyle."
    ]
  },
  {
    ...
    content: [
      ...
      "2. Tech-Cargo Pants: Function meets fashion. Look for neutral tones like olive, sand, or charcoal to match any top in your collection.",
      "3. Statement Hoodies: Don't settle for thin fabrics. A high-GSM hoodie is essential for that premium structure and warmth.",
      "4. Headwear: From beanies to trucker caps, the right accessories complete the 'Hajima' vibe and add layers to your fit."
    ]
  },
  {
    ...
    content: [
      ...
      "Avoid using a dryer as much as possible. High heat can shrink the premium cotton fibers and eventually cause the prints to crack.",
      "Air dry your clothes in the shade. Direct sunlight can bleach the vibrant orange and deep blacks that define our signature fabric colors."
    ]
  },
  {
    ...
    content: [
      ...
      "For a full street-ready outfit, try an oversized orange Hajima tee with black cargo pants and high-top sneakers.",
      "Remember: Confidence is the best accessory. Wear it loud, wear it proud, and let the grind speak for itself."
    ]
  }
];
